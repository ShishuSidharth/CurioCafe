...
const socket = io("https://NDBlogs.onrender.com/");
...
function ProtectedRoute({ children }) {
  ...
  return (
    currentUser && (
      <div className="p-5">
        <div className="bg-primary w-full p-5 justify-between flex rounded items-center navbar">
          <h1
        ...
        <div className="mt-5 h-[85vh]">{children}</div>
      </div>
    )
  );
}
